    ...
    return (
        <div className='group  overflow-hidden text-center rounded-md'>
            <div className='w-full h-64 relative overflow-hidden'>
                <img className='w-full group-hover:rotate-1 duration-200 h-full rounded-b-md object-cover transition-transform transform group-hover:scale-105' src={food_img} alt={`image of ${food_name}`} />
