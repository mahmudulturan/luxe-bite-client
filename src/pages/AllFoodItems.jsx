            ...
            <div>
                <div className="text-center md:text-right items-center">
                    <div className="join flex-col md:flex-row">
                        <div>
                            <div>
                                <input className="input join-item outline-none border-x-0 border-t-0 rounded-none border-secondaryCol border-b-2 bg-transparent focus:outline-none focus:bg-white transition-colors duration-200" placeholder="Search" />
                            </div>
                        </div>
                        ...
                        <div className="indicator">
                            <button className="btn join-item bg-secondaryCol text-darkSecondary hover:text-white hover:bg-darkSecondary border-accentCol border-none focus:outline-none">Search</button>
                        </div>
                    </div>
                </div>
